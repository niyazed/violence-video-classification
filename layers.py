...
if __name__ == '__main__':
    ...
    model.fit(X_train,y_train, epochs=20, verbose=1, validation_data=(X_test,y_test), batch_size=32, callbacks=[keras.callbacks.TensorBoard(log_dir="logs/lstm1/500_epocs{}".format(time()), histogram_freq=1, write_graph=False, write_images=True)])
